    ...
    )
{
  ...
  } while (ExInterlockedAddUlong(&ExpOkToTimeZoneRefresh, (ULONG)-1, &SysTimeSpinLock));
}
    ...
    )
{
  ...
  if (ExInterlockedAddUlong(&ExpOkToTimeZoneRefresh, 1, &SysTimeSpinLock) == 1)
    {
    ...
    )
{
  ...
  if (ExInterlockedAddUlong(&ExpOkToTimeRefresh, (ULONG)1, &SysTimeSpinLock) == 1)
    {
    ...
    )
{
  ...
  if (ExInterlockedAddUlong(&ExpOkToTimeZoneRefresh, (ULONG)-1, &SysTimeSpinLock) == 1)
    {
    ...
    )
{
  ...
  } while (ExInterlockedAddUlong(&ExpOkToTimeRefresh, (ULONG)-1, &SysTimeSpinLock) > 0);
